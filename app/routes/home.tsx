...
const steps = [
    {
        title: "Discover",
        description: "Map your site architecture and connect the data sources that matter.",
    },
    {
        title: "Diagnose",
        description: "Run comprehensive audits that connect technical issues to business impact.",
    },
    {
        title: "Resolve",
        description: "Prioritize fixes and use AI guidance to move from insight to action faster.",
    },
    {
        title: "Monitor",
        description: "Track changes over time and catch new issues before they hurt visibility.",
    },
]
...
const faqs = [
    {
        ...
        answer: "Most tools report metrics. Revserp connects crawl data, Search Console, and AI reasoning into one workflow — so you see why something matters and what to do about it.",
    },
    {
        question: "Do I need an engineering team to use Revserp?",
        answer: "No. The interface is built for operators, marketers, and technical leads alike. Complex findings are explained in plain language with prioritized next steps.",
    },
    {
        question: "How does AEO fit into the platform?",
        answer: "Answer Engine Optimization is built in from the start. We audit how your content is structured for featured snippets, knowledge panels, and generative AI citations.",
    },
    {
        question: "Can I connect multiple sites and team members?",
        answer: "Yes. Revserp is workspace-based. Invite your team, connect multiple properties, and keep everyone aligned on the same visibility data.",
    },
]
        ...
        <header className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-md">
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
                ...
                <nav className="hidden items-center gap-8 md:flex">
                    ...
                    <a href="#method" className="text-sm text-muted-foreground hover:text-foreground">
                        Method
                    </a>
                ...
                <div className="flex items-center gap-2">
                    <Button render={<Link to="/login" />} variant="ghost" size="sm" className="hidden sm:inline-flex">
                        Log in
                    </Button>
            ...
            <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
                ...
                <HeroBounce delay={350}>
                    <p className="mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
                        Audit, monitor, and improve how search and answer engines understand your brand. One workspace for crawls, Search Console, and AI-guided fixes.
                    </p>
                </HeroBounce>
                        ...
                        <div className="rounded-xl border border-border/50 bg-card p-6 text-left">
                            <div className="mb-6 flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Crawl completed just now</p>
                                </div>
        ...
        <section id="solutions" className="px-6 py-24 md:py-32">
            <div className="mx-auto max-w-6xl">
                <div className="mb-16 text-center">
                    <Reveal>
                        <h2 className="text-3xl font-medium tracking-tight md:text-5xl">Our Core Solutions</h2>
                    </Reveal>
                    <Reveal delay={100}>
        ...
        <div className="w-full max-w-sm rounded-xl border border-border/50 bg-card p-6 shadow-lg">
            ...
            <div className="space-y-4">
                ...
                <div className="rounded-lg border border-border/50 bg-background p-4">
                    ...
                    <p className="mt-1 text-sm font-medium">Impressions declining on same URLs</p>
                </div>
            </div>
        </div>
    )
        ...
        <div className="w-full max-w-sm rounded-xl border border-border/50 bg-card p-6 shadow-lg">
            <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-muted-foreground">Scoped to latest crawl</p>
                </div>
            </div>
            <div className="space-y-3 text-sm">
                ...
                <div className="rounded-2xl rounded-tl-none bg-primary/10 p-4 text-foreground">
                    Your latest crawl shows missing breadcrumb schema and thin H1s on 42 category URLs. Fixing these should improve relevance signals.
                </div>
            </div>
        </div>
    )
...
function Method() {
    return (
        <section id="method" className="border-y border-border/50 bg-muted/20 px-6 py-24 md:py-32">
            <div className="mx-auto max-w-6xl">
                <div className="mb-16 text-center">
                    <Reveal>
                        <h2 className="text-3xl font-medium tracking-tight md:text-5xl">The Method</h2>
                    </Reveal>
                    <Reveal delay={100}>
                        <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
                            A simple loop that turns raw crawl data into durable search visibility.
                        </p>
                    </Reveal>
                </div>
    ...
    return (
        <section id="faq" className="px-6 py-24 md:py-32">
            <div className="mx-auto max-w-3xl">
                <div className="mb-16 text-center">
                    <Reveal>
                        <h2 className="text-3xl font-medium tracking-tight md:text-5xl">Questions & Answers</h2>
                    </Reveal>
                    <Reveal delay={100}>
    ...
    return (
        <section className="px-6 py-24 md:py-32">
            <div className="mx-auto max-w-4xl rounded-3xl border border-border/50 bg-muted/20 px-6 py-16 text-center md:px-12">
                ...
                <Reveal delay={100}>
                    <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
                        Join teams that use Revserp to turn search data into clear, prioritized action.
                    </p>
                </Reveal>
                <Reveal delay={200}>
                ...
                <div className="flex flex-col items-start justify-between gap-8 md:flex-row">
                    <div className="max-w-sm space-y-4">
                        ...
                        <p className="text-sm leading-relaxed text-muted-foreground">
                            One workspace for SEO and AEO visibility. Audit, monitor, and improve how the world finds you.
                        </p>
                    </div>
